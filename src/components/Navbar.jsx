            ...
            <div className='flex flex-col'>
                <div className='p-4 flex justify-between items-center bg-neutral-50'>
                    ...
                    <ul className='hidden md:flex'>
                        <li className='text-md mx-2 hover:font-semibold hover:text-emerald-500 text-slate-400'><a href="/">Pricing</a></li>
                        <li className='text-md mx-2 hover:font-semibold hover:text-emerald-500 text-slate-400'><a href="/">Contact</a></li>
                        <li className='text-md mx-2 hover:font-semibold hover:text-emerald-500 text-slate-400'><a href="/">About</a></li>
                    </ul>
                ...
                {mobileNav && <div>
                    <ul className='absolute md:hidden w-full h-screen bg-slate-900 pt-[20%] px-[30%] uppercase z-10'>
