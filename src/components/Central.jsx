            ...
            <div className='flex justify-center py-12 px-4'>
                ...
                <div className="flex flex-col  md:flex-row items-center">
                    ...
                    <div className="flex flex-col justify-center items-center md:items-start">
                        <p className="text-emerald-400  text-xl font-bold my-2 text-center md:text-left">Nice themes and colors, with best code quality</p>
                        ...
                        <button className='hover:scale-105 duration-200 bg-slate-800 text-xl font-bold text-emerald-300 px-12 py-2 rounded-md mt-6 hover:bg-emerald-400 hover:text-emerald-800'>Start</button>
                    </div>
                </div>
